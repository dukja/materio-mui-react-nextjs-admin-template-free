...
import {Grid, Stack, Typography, Select, TextField, Divider,ToggleButtonGroup, ToggleButton,Chip,Button} from '@mui/material';
...
const rowsData1 = [
  createData1('99', 'mpmanager_jp@cafe24corp.com','[수집] 성공 0건', '2023-09-06 18:00', '2023-09-06 18:00',"쇼핑몰"),
  createData1('99', 'mpmanager_jp@cafe24corp.com','[수집] 성공 0건', '2023-09-06 18:00', '2023-09-06 18:00',"쇼핑몰"),
  createData1('99', 'mpmanager_jp@cafe24corp.com','[수집] 성공 0건', '2023-09-06 18:00', '2023-09-06 18:00',"쇼핑몰"),
  createData1('99', 'mpmanager_jp@cafe24corp.com','[수집] 성공 0건', '2023-09-06 18:00', '2023-09-06 18:00',"쇼핑몰"),
  createData1('99', 'mpmanager_jp@cafe24corp.com','[수집] 성공 0건', '2023-09-06 18:00', '2023-09-06 18:00',"쇼핑몰"),
...
const tabData = [
  { label: '전송완료', content: <TableStickyHeader rows={rowsData1} columns={columnsData1}/> },
  { label: '전송실패', content: <TableStickyHeader rows={rowsData1} columns={columnsData1}/> },
  { label: '가져오기', content: <TableStickyHeader rows={rowsData1} columns={columnsData1}/> },
];
...
const ProductListContainer = () => {
  return (
    <SettingTablePresenter
      ...
      TableData={<TableStickyHeader rows={rowsData1} columns={columnsData1}/>}
    />
  )
}
